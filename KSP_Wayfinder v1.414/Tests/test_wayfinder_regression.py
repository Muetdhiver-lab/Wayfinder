...
def assert_decoded_matches_stored(test_case, plans, job_index, abs_tol=1.0):
...
class WayfinderRegressionTests(unittest.TestCase):
    ...
    def test_archipelago_topology_factory_supports_benchmark_topologies(self):
        ...
        self.assertIsInstance(Wayfinder._make_archipelago_topology("ring", 4), pg.ring)
        self.assertIsInstance(Wayfinder._make_archipelago_topology("fully_connected", 4), pg.fully_connected)
    ...
    def test_vanilla_keemo_reference_decodes_from_sqlite(self):
        ...
        assert_decoded_matches_stored(self, plans, ("KEEMo", 0, 400))
    ...
    def test_vanilla_kekkj_reference_decodes_from_sqlite(self):
        ...
        assert_decoded_matches_stored(self, plans, ("KEKKJ", 600, 3000))
    ...
    def test_jnsq_moho_reference_decodes_with_jnsq_time_scale(self):
        ...
        for job_index in plans._reference_rows:
            assert_decoded_matches_stored(self, plans, job_index)
