...
- `KSP_Wayfinder v1.6.0/Examples`: runnable search examples.
- `KSP_Wayfinder v1.6.0/WayfinderCore`: optimization, trajectory, plotting,
  SQLite, and planet-pack modules.
- `KSP_Wayfinder v1.6.0/Tests`: regression tests, benchmark scripts, and
  reference SQLite snapshots.
- `KSP_Wayfinder v1.6.0/legacy`: former Excel datastores and pykep2-era
...
See [`KSP_Wayfinder v1.6.0/DOC/README.md`](KSP_Wayfinder%20v1.6.0/DOC/README.md)
for the usage guide and
[`KSP_Wayfinder v1.6.0/DOC/CHANGE LOG.md`](KSP_Wayfinder%20v1.6.0/DOC/CHANGE%20LOG.md)
for release history.
