# -*- coding: utf-8 -*-
"""Check nearby Vanilla KEKKJ bins with a vinf objective."""
...
BATCH_NAME = "vanilla_kekkj_vinf_bin_check_moderate"
...
def main():
    ...
    optimized = plans.optimize_sqlite(DB_PATH, n=16, batch_name=BATCH_NAME)
    print(f"Optimized {optimized} KEKKJ bin-check jobs")
