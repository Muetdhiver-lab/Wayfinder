...
def gen_vanilla_mga_scan_test():
    ...
    plans.add_batch(
        datastore_name  = 'Vanilla_MGA_Scan_test',
        overwrite       = True,
...
def run_vanilla_mga_scan_test(): 
    ...
    plans = Wayfinder(planet_pack = "Vanilla",datastore_name = 'Vanilla_MGA_Scan_test')
    plans.load_df(datastore_name = 'Vanilla_MGA_Scan_test')  
    swing_by_bodies = [["Kerbin"],["Eve"],["Eve","*"],["Moho"]]
